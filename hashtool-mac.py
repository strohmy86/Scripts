...
while True:
    ...
    if selection == '1':
        ...
        cmd = 'echo -n "'+string+'" | md5 | cut -d " " -f1'
        print('\n')
        ...
        string = input('Please input a string you would like to hash:  ')
        cmd = 'echo -n "'+string+'" | shasum -a 1 | cut -d " " -f1'
        print('\n')
        print('Your hashed string is:  \n')
        os.system(cmd)
        print('\n')
        ...
        string = input('Please input a string you would like to hash:  ')
        cmd = 'echo -n "'+string+'" | shasum -a 256 | cut -d " " -f1'
        print('\n')
        print('Your hashed string is:  \n')
        os.system(cmd)
        print('\n')
        ...
        string = input('Please input a string you would like to hash:  ')
        cmd = 'echo -n "'+string+'" | shasum -a 512 | cut -d " " -f1'
        print('\n')
        print('Your hashed string is:  \n')
        os.system(cmd)
        print('\n')
        ...
        cmd = 'echo -n "'+string+'" | openssl base64'
        print('\n')
        ...
        cmd = 'echo -n '+string+' | openssl base64 -d'
        print('\n')
